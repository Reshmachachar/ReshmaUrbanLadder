...
public class An_ExtentReport  extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		String reportName = "BookShelves_Report" + timestamp + ".html";

		extentSparkReporter=new ExtentSparkReporter(".//Reports//"+reportName);
		extentSparkReporter.config().setDocumentTitle("Automation Report");
		extentSparkReporter.config().setReportName("UrbanLadder Testing Report");
		...
		extentReports.setSystemInfo("APP URL", "https://www.urbanladder.com/");
